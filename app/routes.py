...
def vehicle_entry():
    form = VehicleForm()
    if form.validate_on_submit():
        vehicle = Vehicle(costno=form.costno.data, grease_interval=form.grease_interval.data,
                          oil_change_interval=form.oil_change_interval.data,
                          preventative_maintenance_interval=form.preventative_maintenance_interval.data)
